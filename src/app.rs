...
#[command(name = "shreds", version = "1.0", author = "mtfuji25")]
pub struct Args {
    ...
    #[arg(long, default_value = "http://shredstream-sniper-backend.heroku.app")]
...
pub enum Command {
    ...
    /// Run all service modes concurrently (Arb, Pump, Graduates)
    All,
}
